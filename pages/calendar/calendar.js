...
let choose_year = null,
  ...
  ready() {
    const t = this.properties.dateTime
    const todate = new Date();
    const dateFormat = new Date(t)
      , month = this.formatMonth(dateFormat.getMonth() + 1)
      , year = dateFormat.getFullYear()
      , day = this.formatDay(dateFormat.getDate())
      , today = `${todate.getFullYear()}-${this.formatMonth(todate.getMonth() + 1)}-${this.formatDay(todate.getDate())}`
...
//   },
  ...
  bindDayTap(e) {
    ...
    this.triggerEvent('changes',{'date':beSelectDate})
  },
  bindDateChange(e) {
    console.log(e);
